...
interface Concept {
  ...
  category: string; // Future-proof for filtering
}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <section>
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Fundamentals</h2>
            <p className="text-gray-600">
              Essential SQL concepts to master database querying
            </p>
          </div>
